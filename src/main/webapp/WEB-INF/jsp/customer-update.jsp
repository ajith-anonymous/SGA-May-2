...
<body>
    <div class="form-card">
        ...
        <p class="subtitle">Modify the customer details below</p>
        <span class="id-badge">Customer ID: #${customer.id}</span>

        <c:if test="${not empty errorMessage}">
            <div class="alert alert-error">❌ ${errorMessage}</div>
        </c:if>

        <form:form method="POST" action="${pageContext.request.contextPath}/customers/update/${customer.id}" modelAttribute="customer">
