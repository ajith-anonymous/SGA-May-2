...
<body>
    <div class="form-card">
        ...
        <form:form method="POST" action="${pageContext.request.contextPath}/orders/add" modelAttribute="order">
            ...
            <div class="btn-group">
                <a href="${pageContext.request.contextPath}/orders/list" class="btn btn-secondary">← Back</a>
